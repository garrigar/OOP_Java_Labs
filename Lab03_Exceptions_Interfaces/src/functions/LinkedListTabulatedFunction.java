...
public class LinkedListTabulatedFunction implements TabulatedFunction {
     ...
     * @throws InappropriateFunctionPointException - if X coordinate of new point is equal or less than last list item's X
     */
    private void appendPoint(FunctionPoint fp) throws InappropriateFunctionPointException {
        if (head.prev.item.getX() < fp.getX()) {
            this.addNodeToTail().item = new FunctionPoint(fp);
        } else
            throw new InappropriateFunctionPointException("X coordinate of point being added (x = " + fp.getX() + ") must be " +
